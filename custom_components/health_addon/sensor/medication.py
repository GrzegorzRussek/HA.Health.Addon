...
class MedicationSensor(SensorEntity):
    ...
    def __init__(self, database: Database, medication_id: int, name: str, dosage: str):
    ...
    def unique_id(self) -> str:
        return f"health_addon_medication_{self._medication_id}"
    ...
    async def async_update(self) -> None:
        ...
        try:
            ...
            meds = await self._database.get_medications()
            ...
            if med:
                ...
                # Check last dose
                last_dose = await self._database.get_last_dose(self._medication_id)
                if last_dose:
                    ...
                    # Get recent logs
                    logs = await self._database.get_medication_logs(self._medication_id, limit=10)
    ...
    async def log_dose(self) -> None:
        ...
        await self._database.log_medication_taken(self._medication_id)
